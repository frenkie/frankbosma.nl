module.exports = {
    env: {
        ...
        NEXT_PUBLIC_DATA_PATH: '/data/20210520-home.json', // will be fetched client side
        NEXT_PUBLIC_DATA_PATH_RESUME: '/data/20210520-resume.json' // will be fetched client side
    }
};